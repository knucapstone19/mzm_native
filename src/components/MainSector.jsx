...
const MainSector = ({ title, parts, src, width, idx }) => {
  return (
    <View
        ...
        >
          <View className="flex-row">
            <View className="flex-col z-10">
              <Text className="pb-2 font-main text-lg text-[#111111]">
                {title}
              </Text>
              <Text>
                {parts.map((part, idx) => (
            ...
            <Image className="absolute -right-4 -bottom-5" source={src} />
          </View>
        </TouchableOpacity>
      </View>
    </View>
